...
export interface ICheckListTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ICheckListTabRemoveProps {

}

/**
 * Implementation of check list remove page
 */
export class CheckListTabRemove  extends TeamsBaseComponent<ICheckListTabRemoveProps, ICheckListTabRemoveState> {
